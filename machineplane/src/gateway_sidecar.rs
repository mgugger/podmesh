...
pub const DEFAULT_GATEWAY_IMAGE: &str = "beemesh/gateway";
/// Host-side directory prefix where gateway metadata files are written.
pub const GATEWAY_METADATA_HOST_ROOT: &str = "/var/lib/beemesh/gateway";
...
pub const GATEWAY_SIDECAR_CONTAINER_NAME: &str = "beemesh-gateway";
/// Volume name used for the gateway metadata mount.
pub const GATEWAY_VOLUME_NAME: &str = "beemesh-gateway-metadata";
