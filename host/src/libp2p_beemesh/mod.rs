...
use beemesh_protocol::libp2p_constants::BEEMESH_CLUSTER;
                ...
                if let Some(msg) = maybe_msg {
                    match msg {
                        Libp2pControl::QueryCapacityWithPayload { request_id, reply_tx, payload } => {
                            ...
                            match beemesh_protocol::machine::root_as_capacity_request(&payload) {
                                Ok(cap_req) => {
                                    ...
                                    let cap_args = beemesh_protocol::machine::CapacityRequestArgs {
                                    ...
                                    let cap_off = beemesh_protocol::machine::CapacityRequest::create(&mut fbb, &cap_args);
                                    beemesh_protocol::machine::finish_capacity_request_buffer(&mut fbb, cap_off);
                        ...
                        Libp2pControl::SendApplyRequest { peer_id, manifest, reply_tx } => {
                            ...
                            let apply_request = beemesh_protocol::machine::build_apply_request(
                                1, // replicas
                                "default", // tenant
                                &operation_id,
                                &manifest_json,
            ...
            event = swarm.select_next_some() => {
                match event {
                    SwarmEvent::Behaviour(MyBehaviourEvent::HandshakeRr(request_response::Event::Message { message, peer, connection_id: _ })) => {
                        match message {
                            request_response::Message::Request { request, channel, .. } => {
                                ...
                                match beemesh_protocol::machine::root_as_handshake(&request) {
                                    Ok(handshake_req) => {
                                        ...
                                        let response = beemesh_protocol::machine::build_handshake(0, 0, "TODO", "TODO");
                                    ...
                                    Err(e) => {
                                        ...
                                        let error_response = beemesh_protocol::machine::build_handshake(0, 0, "TODO", "TODO");
                            ...
                            request_response::Message::Response { response, .. } => {
                                ...
                                // Parse the response
                                match beemesh_protocol::machine::root_as_handshake(&response) {
                                    Ok(handshake_resp) => {
                    ...
                    SwarmEvent::Behaviour(MyBehaviourEvent::ApplyRr(request_response::Event::Message { message, peer, connection_id: _ })) => {
                        match message {
                            request_response::Message::Request { request, channel, .. } => {
                                ...
                                match beemesh_protocol::machine::root_as_apply_request(&request) {
                                    Ok(apply_req) => {
                                        ...
                                        let response = beemesh_protocol::machine::build_apply_response(
                                            true,
                                    ...
                                    Err(e) => {
                                        ...
                                        let error_response = beemesh_protocol::machine::build_apply_response(
                                            false,
                                            "unknown",
                            ...
                            request_response::Message::Response { response, .. } => {
                                ...
                                // Parse the response
                                match beemesh_protocol::machine::root_as_apply_response(&response) {
                                    Ok(apply_resp) => {
                    ...
                    SwarmEvent::Behaviour(MyBehaviourEvent::Gossipsub(gossipsub::Event::Message {
                        ...
                        if let Ok(cap_req) = beemesh_protocol::machine::root_as_capacity_request(&message.data) {
                            ...
                            let reply_args = beemesh_protocol::machine::CapacityReplyArgs {
                                request_id: Some(req_id_off),
                                ok: true,
                            ...
                            let reply_off = beemesh_protocol::machine::CapacityReply::create(&mut fbb, &reply_args);
                            beemesh_protocol::machine::finish_capacity_reply_buffer(&mut fbb, reply_off);
                            let finished = fbb.finished_data().to_vec();
                        ...
                        if let Ok(cap_reply) = beemesh_protocol::machine::root_as_capacity_reply(&message.data) {
            ...
            _ = handshake_interval.tick() => {
                ...
                for (peer_id, state) in handshake_states.iter_mut() {
                    ...
                    if state.last_attempt.elapsed() >= Duration::from_secs(2) {
                        ...
                        let handshake_request = beemesh_protocol::machine::build_handshake(0, 0, "TODO", &handshake_signature);
