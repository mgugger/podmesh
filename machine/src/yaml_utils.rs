...
/// Parse all YAML documents from a byte slice, skipping null/empty docs.
...
/// Parse all YAML documents from a string slice.
...
/// Serialize YAML documents back into a single string separated by document delimiters.
