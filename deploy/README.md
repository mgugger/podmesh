...
Then run
```
podman kube play deploy/complete.yml --network podmesh
```
...
./target/debug/podctl --api-url http://localhost:3000 apply -f machineplane/tests/sample_manifests/nginx.yml
```
